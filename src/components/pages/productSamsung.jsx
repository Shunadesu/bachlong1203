...
import {useProductSamsungValentine} from "../../apis";
import Slider from "react-slick";
import { useSlidesToShow } from "../hook/settingsSlide";
const ProductSamsungList = () => {
  const { data, isLoading, error } = useProductSamsungValentine();
...
export default ProductSamsungList;
