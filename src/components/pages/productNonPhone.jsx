...
import {useProductNonPhoneValentine} from "../../apis";
import { useSlidesToShow } from "../hook/settingsSlide";
import Slider from "react-slick";
const ProductNonPhoneList = () => {
  const { data, isLoading, error } = useProductNonPhoneValentine();
...
export default ProductNonPhoneList;
